        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-1 mb-3">
                    <a href="{{ route('fertilizer.create') }}" class="btn btn-block btn-primary">Добавить</a>
                </div>
            </div>
            <div class="row"
        ...
        <div class="card-body table-responsive p-0" style="height: 300px;">
            <table class="table table-head-fixed text-nowrap">
                ...
                @foreach($fertilizers as $fertilizer)
                    ...
                    <td><a href="{{ route('fertilizer.show', $fertilizer->id) }}"><i class="far fa-eye"></i></a></td>
                    <td><a href="{{ route('fertilizer.edit', $fertilizer->id) }}"
